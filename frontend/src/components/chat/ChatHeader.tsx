...
const ChatHeader: React.FC<ChatHeaderProps> = ({
  ...
  return (
    <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-6 rounded-t-2xl flex items-center justify-between shadow-lg">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h3 className="font-bold text-lg">Unitasa Assistant</h3>
